...
export function VideoFinderPage() {
  ...
  return <div className="video-finder-page">
    <header className="page-hero"><div><div className="eyebrow">Staff curriculum helper</div><h1 className="page-title">Video Finder Helper</h1><p className="muted">Find, review, and save an approved YouTube video to a curriculum module. Saving a video never changes curriculum publication status.</p></div></header>
