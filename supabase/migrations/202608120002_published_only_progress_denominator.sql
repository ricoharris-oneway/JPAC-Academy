...
-- Safe Draft Isolation: only published modules are student-actionable denominator members.
-- This migration intentionally performs no stored-progress reconciliation.
...
comment on column public.enrollments.progress is
  'Canonical active-level mastery percentage: mastered modules divided by all published modules in the enrollment current level. Not lesson progress or XP progress.';
