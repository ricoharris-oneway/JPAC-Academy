-- JPAC Acting 46-module draft rollout rollback. Removes batch-created Acting rows only.
begin;
do $$
declare v_course uuid; v_marker constant text:='Acting full draft rollout 202608140002'; v_count int;
begin
 ...
 raise notice 'Removed % exact batch-created Acting modules; compatible pre-existing rows preserved',v_count;
end $$;
commit;
