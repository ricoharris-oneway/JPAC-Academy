-- JPAC Digital AI Creator 48-module draft rollout rollback. Removes exact batch-created rows only.
begin;
do $$
declare v_course uuid; v_marker constant text:='Digital AI Creator full draft rollout 202608140009'; v_count int;
begin
 ...
 raise notice 'Removed % exact batch-created Digital AI Creator modules; compatible pre-existing rows preserved',v_count;
end $$;
commit;
