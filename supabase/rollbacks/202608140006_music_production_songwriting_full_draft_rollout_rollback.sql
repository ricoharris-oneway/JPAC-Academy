-- JPAC Music Production/Songwriting 48-module draft rollout rollback. Removes exact batch-created rows only.
begin;
do $$
declare v_course uuid; v_marker constant text:='Music Production/Songwriting full draft rollout 202608140006'; v_count int;
begin
 ...
 raise notice 'Removed % exact batch-created Music Production/Songwriting modules; compatible pre-existing rows preserved',v_count;
end $$;
commit;
